...
// Methods.
i._hide=function(e){l.target.hasClass(l.visibleClass)&&(e&&(e.preventDefault(),e.stopPropagation()),// Hide.
...
if(l.hideOnSwipe){var n=!1;switch(l.side){case"left":n=a<20&&a>-20&&t>50;break;case"right":n=a<20&&a>-20&&t<-50;break;case"top":n=t<20&&t>-20&&a>50;break;case"bottom":n=t<20&&t>-20&&a<-50}if(n)return i.touchPosX=null,i.touchPosY=null,i._hide(),!1}(0>i.scrollTop()&&a<0||o>r-2&&o<r+2&&a>0)&&(e.preventDefault(),e.stopPropagation())}}),// Event: Prevent certain events inside the panel from bubbling.
...
i.data(l,t)}}})};//# sourceMappingURL=index.43275036.js.map

//# sourceMappingURL=index.43275036.js.map
